...
class ZoneoutLSTMCell(LayerRNNCell):
    ...
    def call(self, inputs, state):
        ...
        zoneout_c = (1-self.cell_zoneout_rate) * self.dropout_no_scale(c - c_prev, rate=self.cell_zoneout_rate, is_training=self.is_training) + c_prev
        zoneout_m = (1-self.output_zoneout_rate) * self.dropout_no_scale(m - m_prev, rate=self.output_zoneout_rate, is_training=self.is_training) + m_prev
